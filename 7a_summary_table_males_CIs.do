...
keep if _mi_m==1
**
drop if case_control==3
* post-pscore table
label define male 0 "general clinics" 1 "Male Clinic ($exclude ) " 
file open scy using "baseline_vars_$nowd combined_km_sbm .csv", write replace
